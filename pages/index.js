    ...
    <Layout>
        ...
        <div className="row py-5">
            <div className="col-md-3">
                <div className="btn-group-vertical col-12 py-4  ">
                    ...
                    <label className="btn text-warning text-start fw-bold f-sec fs-6" for="btnradio1">TODOS 
                     <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right-short me-auto " viewBox="0 0 16 16">  <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/></svg>
                     </label>

                    <input type="radio" className="btn-check " name="btnradio" id="btnradio2" autocomplete="off"></input>
                    <label className="btn text-start fw-bold f-sec fs-6" for="btnradio2 ">PRODUCTOS</label>

                    <input type="radio" className="btn-check" name="btnradio" id="btnradio3" autocomplete="off"></input>
                    <label className="btn text-start fw-bold f-sec fs-6" for="btnradio3">RECETAS</label>

                    <input type="radio" className="btn-check" name="btnradio" id="btnradio4" autocomplete="off"></input>
                    <label className="btn text-start fw-bold f-sec fs-6"  for="btnradio4">CONSEJOS</label>
                </div>
            </div>
            <div className="col-md-9">
              ...
              {articles.map(({ title, content,image }, index) => (
                    <div className="col-md-4 py-4" key={index}>
                        <div className="card shadow p-3 mb-1 bg-body rounded h-100">
        ...
        <div className="container col-8 f-sec fw-bold">
            <form action="/send-data" className="row g-3" method="POST">
                ...
                <div className="col-md-6">
                    <label for="inputLName" className="form-label">APELLIDO</label>
                    <input type="password" className="form-control" id="inputLName" name="lastname" required></input>
                </div>
                <div className="col-md-6">
                    <label for="inputEmail" className="form-label">MAIL</label>
                    <input type="email" className="form-control" id="inputEmail" name="email" required></input>
                </div>
                <div className="col-md-6">
                    <label for="inputCellphone" className="form-label">TELEFONO</label>
                    <input type="tel" className="form-control" id="inputCellphone" name="phone" required></input>
                </div>

                <div className="row justify-content-end p-3">

                    <div className="col-2 ">
                        <button type="submit" className="btn btn-warning ms-auto">Enviar</button>
                    </div>
                </div>
            </form>
        </div>
